...
class MainView(Qw.QMainWindow):  # REVIEW Code Class
    ...
    def create_menus(self):
        ...
        exit_action = Qw.QAction('&Exit', self, shortcut="Ctrl+E", triggered=self.exit_run)
    ...
    def export_project_data(self):
        ...
        # noinspection PyCallByClass
        export_file = Qw.QFileDialog.getSaveFileName(self, "Save file", file_name, "*.csv")[0]
        if export_file:
            # append file extention if neccessary
    ...
    def exit_run(self):
        ...
        yes_button = dialog.addButton("Exit", Qw.QMessageBox.AcceptRole)
        save_button = dialog.addButton("Save then exit", Qw.QMessageBox.AcceptRole)
        dialog.addButton("Cancel", Qw.QMessageBox.RejectRole)
        dialog.exec_()
    ...
    def preview_all_scans(self):
        ...
        """
        # noinspection PyCallByClass
        timer, ok = Qw.QInputDialog.getDouble(self, "Time of each preview",
    ...
    def show_auto_align_dialog(self):
        ...
        message.setIcon(Qw.QMessageBox.Question)
        ...
        message.setStandardButtons(Qw.QMessageBox.Yes | Qw.QMessageBox.No)
        message.setDefaultButton(Qw.QMessageBox.No)
        ret = message.exec_()
    ...
    def create_left_docker(self):
        ...
        return [scaninfo_docker, sigmoid_docker, kappa_docker]
    ...
    def create_progress_bar(self):
        ...
        """
        progress_dialog = Qw.QProgressDialog("Starting..", "Cancel", 0, 100, self)
    ...
    def show_error_message(err_type):
        ...
        if err_type == "no_data":
            ...
            pass
        warning_msbx = Qw.QMessageBox()
        warning_msbx.setIcon(Qw.QMessageBox.Warning)
    ...
    def show_information_message(title=None, text=None, subtext=None):
        ...
        """
        warning = Qw.QMessageBox()
        warning.setIcon(Qw.QMessageBox.Information)
    ...
    def get_counts_to_conc_conv(self):
        ...
        # noinspection PyCallByClass
        cc = Qw.QInputDialog.getDouble(self, "Counts to concentration conversion", "Counts to concentration conversion",
    ...
    def show_auto_manual_fit_sigmoid_dialog(self):
        ...
        dialog.setIcon(Qw.QMessageBox.Question)
        dialog.addButton("Manual", Qw.QMessageBox.RejectRole)
        auto_button = dialog.addButton("Auto", Qw.QMessageBox.AcceptRole)
        dialog.exec_()
